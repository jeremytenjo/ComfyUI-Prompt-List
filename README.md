...
2. Set inputs:
   ...
   - `prompt_negative_suffix` (optional): text appended literally to every negative output prompt
   - `prompt_negative_prefix` (optional): text prepended literally to every negative output prompt
3. Connect outputs:
...
Negative prefix/suffix example:
